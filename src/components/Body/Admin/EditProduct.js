...
const AddProduct = () => {
    ...
    const clickHandler = () => {
        ...
        axios
            .post(`http://kdt-ai6-team12.elicecoding.com/api/products/edit/${id}`, {...formData }, { headers: { Authorization: token } })
            .then(() => {
                alert('상품 수정 완료')
    ...
    return ( <
        ...
        input type = "text"
        name = "searchKeywords"
        defaultValue = { item.searchKeywords }
        onChange = {
